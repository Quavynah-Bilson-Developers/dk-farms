...
import io.peanutsdk.util.AnimUtils;
...
public class InkPageIndicator extends View implements ViewPager.OnPageChangeListener,
	...
	private static final String TAG = "InkPageIndicator";
	...
	private void setCurrentPageImmediate() {
		...
		if (dotCenterX != null) {
			try {
				...
				Log.e(TAG, "setCurrentPageImmediate: ",e);
			}
		}*/
		
		if (viewPager != null) {
			currentPage = viewPager.getCurrentItem();
			if (dotCenterX != null) selectedDotX = dotCenterX[currentPage];
		}
	}
