...
public class AnimUtils {
	...
	public static <T> Property<T, Integer> createIntProperty(final IntProp<T> impl) {
		/*return Build.VERSION.SDK_INT >= Build.VERSION_CODES.N ? new IntProperty<T>(impl.name) {
			@Override
		...
		} : new Property<T, Integer>(Integer.class, impl.name) {
			@Override
			public Integer get(T object) {
				return impl.get(object);
			}
	...
	public static <T> Property<T, Float> createFloatProperty(final FloatProp<T> impl) {
		/*return Build.VERSION.SDK_INT >= Build.VERSION_CODES.N ? new FloatProperty<T>(impl.name) {
			@Override
		...
		} : new Property<T, Float>(Float.class, impl.name) {
			@Override
			public Float get(T object) {
				return impl.get(object);
			}
